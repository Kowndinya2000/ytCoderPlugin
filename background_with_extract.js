setTimeout(() => {
    ...
    if(t2)
    {
        if(t2.length == 1)
        {
            ...
            {
                document.getElementById('secondary').innerHTML =   '<iframe src="https://www.onlinegdb.com/online_haskell_compiler" frameborder="0" style="min-width: 55rem;resize: horizontal;overflow: auto;;height: 48rem;"></iframe>';
                document.querySelectorAll('.style-scope.ytd-video-primary-info-renderer')[8].innerHTML = button_code + document.querySelectorAll('.style-scope.ytd-video-primary-info-renderer')[8].innerHTML         
            }
            ...
            {
                document.getElementById('secondary').innerHTML =   '<iframe src="https://www.onlinegdb.com/online_sqlite_editor" frameborder="0" style="min-width: 55rem;resize: horizontal;overflow: auto;;height: 48rem;"></iframe>';
                document.querySelectorAll('.style-scope.ytd-video-primary-info-renderer')[8].innerHTML = button_code + document.querySelectorAll('.style-scope.ytd-video-primary-info-renderer')[8].innerHTML         
            }
            ...
            {
                document.getElementById('secondary').innerHTML =   '<iframe src="https://www.onlinegdb.com/online_rust_compiler" frameborder="0" style="min-width: 55rem;resize: horizontal;overflow: auto;;height: 48rem;"></iframe>';
                document.querySelectorAll('.style-scope.ytd-video-primary-info-renderer')[8].innerHTML = button_code + document.querySelectorAll('.style-scope.ytd-video-primary-info-renderer')[8].innerHTML         
            }
            else if(t1.includes(" R") == true || t1.includes("R ") == true)
            {
                document.getElementById('secondary').innerHTML =   '<iframe src="https://www.onlinegdb.com/online_r_interpreter" frameborder="0" style="min-width: 55rem;resize: horizontal;overflow: auto;;height: 48rem;"></iframe>';
                document.querySelectorAll('.style-scope.ytd-video-primary-info-renderer')[8].innerHTML = button_code + document.querySelectorAll('.style-scope.ytd-video-primary-info-renderer')[8].innerHTML         
            }
            else if(t1.includes("GO") == true || t1.includes("Go") == true)
            {
                document.getElementById('secondary').innerHTML =   '<iframe src="https://www.onlinegdb.com/online_go_compiler" frameborder="0" style="min-width: 55rem;resize: horizontal;overflow: auto;;height: 48rem;"></iframe>';
                document.querySelectorAll('.style-scope.ytd-video-primary-info-renderer')[8].innerHTML = button_code + document.querySelectorAll('.style-scope.ytd-video-primary-info-renderer')[8].innerHTML        
            }
            else if(t1.includes("BASH") == true || t1.includes("Bash") == true || t1.includes("bash") == true)
            {
                document.getElementById('secondary').innerHTML =   '<iframe src="https://www.onlinegdb.com/online_bash_shell" frameborder="0" style="min-width: 55rem;resize: horizontal;overflow: auto;;height: 48rem;"></iframe>';
            ...
            {
                document.getElementById('secondary').innerHTML =   '<iframe src="https://www.onlinegdb.com/online_html_compiler" frameborder="0" style="min-width: 55rem;resize: horizontal;overflow: auto;;height: 48rem;"></iframe>';
                document.querySelectorAll('.style-scope.ytd-video-primary-info-renderer')[8].innerHTML = button_code + document.querySelectorAll('.style-scope.ytd-video-primary-info-renderer')[8].innerHTML
            }
            ...
            {
                document.getElementById('secondary').innerHTML =   '<iframe src="https://www.onlinegdb.com/online_javascript_rhino_interpreter" frameborder="0" style="min-width: 55rem;resize: horizontal;overflow: auto;;height: 48rem;"></iframe>';
                document.querySelectorAll('.style-scope.ytd-video-primary-info-renderer')[8].innerHTML = button_code + document.querySelectorAll('.style-scope.ytd-video-primary-info-renderer')[8].innerHTML
            }
            else if(t1.includes("java") == true || t1.includes("Java") == true || t1.includes("JAVA") == true)
            {
                document.getElementById('secondary').innerHTML =   '<iframe src="https://www.jdoodle.com/embed/v0/24TF" id="java_frame" frameborder="0" style="min-width: 25rem;resize: both;overflow: auto;;height: 48rem;"></iframe>';
                document.querySelectorAll('.style-scope.ytd-video-primary-info-renderer')[8].innerHTML = button_code + document.querySelectorAll('.style-scope.ytd-video-primary-info-renderer')[8].innerHTML
            }
            else if(t1.includes("VB") == true || t1.includes("Vb") == true || t1.includes("vb") == true)
            {
                document.getElementById('secondary').innerHTML =   '<iframe src="https://www.onlinegdb.com/online_vb_compiler" frameborder="0" style="min-width: 55rem;resize: horizontal;overflow: auto;;height: 48rem;"></iframe>';
                document.querySelectorAll('.style-scope.ytd-video-primary-info-renderer')[8].innerHTML = button_code + document.querySelectorAll('.style-scope.ytd-video-primary-info-renderer')[8].innerHTML
            }
