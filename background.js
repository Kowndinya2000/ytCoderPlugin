setTimeout(() => {
    ...
    if(t2)
    {
        if(t2.length == 1)
        {
            ...
            {
                document.getElementById('secondary').innerHTML =   '<iframe src="https://www.jdoodle.com/online-compiler-c++/" frameborder="0" style="width: 100%;height: 60rem;border-color: blue;border: 2px solid blue;"></iframe>';
            ...
            {
                document.getElementById('secondary').innerHTML =   '<iframe src="https://www.jdoodle.com/python3-programming-online/" frameborder="0" style="width: 100%;height: 60rem;border-color: blue;border: 2px solid blue;"></iframe>';
                document.querySelectorAll('.style-scope.ytd-video-primary-info-renderer')[8].innerHTML = button_code + document.querySelectorAll('.style-scope.ytd-video-primary-info-renderer')[8].innerHTML
            }
            else if(t1.includes("php") == true || t1.includes("PHP") == true || t1.includes("Php") == true)
            {
                document.getElementById('secondary').innerHTML =   '<iframe src="https://www.jdoodle.com/php-online-editor/" frameborder="0" style="width: 100%;height: 60rem;border-color: blue;border: 2px solid blue;"></iframe>';
                document.querySelectorAll('.style-scope.ytd-video-primary-info-renderer')[8].innerHTML = button_code + document.querySelectorAll('.style-scope.ytd-video-primary-info-renderer')[8].innerHTML         
            }
            else if(t1.includes("ruby") == true || t1.includes("Ruby") == true || t1.includes("RUBY") == true)
            {
                document.getElementById('secondary').innerHTML =   '<iframe src="https://www.jdoodle.com/execute-ruby-online/" frameborder="0" style="width: 100%;height: 60rem;border-color: blue;border: 2px solid blue;"></iframe>';
                document.querySelectorAll('.style-scope.ytd-video-primary-info-renderer')[8].innerHTML = button_code + document.querySelectorAll('.style-scope.ytd-video-primary-info-renderer')[8].innerHTML         
            }
            else if(t1.includes("perl") == true || t1.includes("Perl") == true || t1.includes("PERL") == true)
            {
                document.getElementById('secondary').innerHTML =   '<iframe src="https://www.jdoodle.com/execute-perl-online/" frameborder="0" style="width: 100%;height: 60rem;border-color: blue;border: 2px solid blue;"></iframe>';
                document.querySelectorAll('.style-scope.ytd-video-primary-info-renderer')[8].innerHTML = button_code + document.querySelectorAll('.style-scope.ytd-video-primary-info-renderer')[8].innerHTML         
            }
            else if(t1.includes("PASCAL") == true || t1.includes("Pascal") == true || t1.includes("pascal") == true)
            {
                document.getElementById('secondary').innerHTML =   '<iframe src="https://www.jdoodle.com/execute-pascal-online/" frameborder="0" style="width: 100%;height: 60rem;border-color: blue;border: 2px solid blue;"></iframe>';
                document.querySelectorAll('.style-scope.ytd-video-primary-info-renderer')[8].innerHTML = button_code + document.querySelectorAll('.style-scope.ytd-video-primary-info-renderer')[8].innerHTML         
            }
            
            else if(t1.includes("FORTRAN") == true || t1.includes("Fortran") == true || t1.includes("fortran") == true)
            {
                document.getElementById('secondary').innerHTML =   '<iframe src="https://www.jdoodle.com/execute-fortran-online/" frameborder="0" style="width: 100%;height: 60rem;border-color: blue;border: 2px solid blue;"></iframe>';
                document.querySelectorAll('.style-scope.ytd-video-primary-info-renderer')[8].innerHTML = button_code + document.querySelectorAll('.style-scope.ytd-video-primary-info-renderer')[8].innerHTML         
            }
            ...
            {
                document.getElementById('secondary').innerHTML =   '<iframe src="https://www.jdoodle.com/compile-assembler-gcc-online/" frameborder="0" style="width: 100%;height: 60rem;border-color: blue;border: 2px solid blue;"></iframe>';
                document.querySelectorAll('.style-scope.ytd-video-primary-info-renderer')[8].innerHTML = button_code + document.querySelectorAll('.style-scope.ytd-video-primary-info-renderer')[8].innerHTML         
            }
            else if(t1.includes("Objective C") == true || t1.includes("objective C") == true || t1.includes("objectiveC") == true)
            {
                document.getElementById('secondary').innerHTML =   '<iframe src="https://www.jdoodle.com/execute-objective-c-online/" frameborder="0" style="width: 100%;height: 60rem;border-color: blue;border: 2px solid blue;"></iframe>';
                document.querySelectorAll('.style-scope.ytd-video-primary-info-renderer')[8].innerHTML = button_code + document.querySelectorAll('.style-scope.ytd-video-primary-info-renderer')[8].innerHTML         
            }
            ...
            {
                document.getElementById('secondary').innerHTML =   '<iframe src="https://www.jdoodle.com/execute-prolog-online/" frameborder="0" style="width: 100%;height: 60rem;border-color: blue;border: 2px solid blue;"></iframe>';
                document.querySelectorAll('.style-scope.ytd-video-primary-info-renderer')[8].innerHTML = button_code + document.querySelectorAll('.style-scope.ytd-video-primary-info-renderer')[8].innerHTML         
            }
            else if(t1.includes("SWIFT") == true || t1.includes("Swift") == true || t1.includes("swift") == true)
            {
                document.getElementById('secondary').innerHTML =   '<iframe src="https://www.jdoodle.com/execute-swift-online/" frameborder="0" style="width: 100%;height: 60rem;border-color: blue;border: 2px solid blue;"></iframe>';
