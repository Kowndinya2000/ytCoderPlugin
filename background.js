setTimeout(() => {
    ...
    if(t2)
    {
        if(t2.length == 1)
        {
            ...
            {
                document.getElementById('secondary').innerHTML =  button_code  + '<iframe src="https://www.onlinegdb.com/online_c++_compiler" frameborder="0" style="width: 100%;height: 60rem;border-color: blue;border: 2px solid blue;"></iframe>';
            ...
            {
                document.getElementById('secondary').innerHTML =  button_code  + '<iframe src="https://www.onlinegdb.com/online_python_compiler" frameborder="0" style="width: 100%;height: 60rem;border-color: blue;border: 2px solid blue;"></iframe>';
                document.getElementById('primary').style.width = '160rem'; 
            }
            ...
            {
                document.getElementById('secondary').innerHTML =  button_code  + '<iframe src="https://www.onlinegdb.com/online_java_compiler" frameborder="0" style="width: 100%;height: 60rem;border-color: blue;border: 2px solid blue;"></iframe>';
                document.getElementById('primary').style.width = '160rem'; 
            }
